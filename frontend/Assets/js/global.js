...
function blockHover(status)
{
	...
	if (screenLg){
		$('.product_content .item').hover(
			function() {
				$(this).find('.left-block a.quick-view').removeClass('zoomOut').addClass('zoomIn');
				$(this).find('.left-block .price-box').removeClass('fadeInDown').addClass('fadeOutUp');
				$(this).find('.left-block .btn_content').css('opacity','1').removeClass('fadeOutDown').addClass('fadeInUp');
			}, function() {
				$(this).find('.left-block a.quick-view').removeClass('zoomIn').addClass('zoomOut');
				$(this).find('.left-block .price-box').removeClass('fadeOutUp').addClass('fadeInDown');
				$(this).find('.left-block .btn_content').removeClass('fadeInUp').addClass('fadeOutDown');
			}
		);
	}
}
